...
(defun color-theme-molokai ()
  ...
  (color-theme-install
   '(color-theme-molokai
     ...
     (default ((t (:foreground "#F8F8F2" :background "#0D0E0F"))))
     (bold ((t (:weight bold))))
     ...
     (font-lock-comment-face ((t (:foreground "#696659" :slant italic))))
     (font-lock-comment-delimiter-face ((t (:foreground "#696659" :slant italic))))
     ...
     (markdown-comment-face ((t (:foreground "#696659"))))
     ...
     (show-paren-match-face ((t (:foreground "#000000" :background "#6B5233"))))
